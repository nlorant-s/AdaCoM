...
class AnthropicChatModel(ChatModelBase):
    ...
    async def __call__(
        ...
        **generate_kwargs: Any,
        ...
        if self.stream:
            return self._parse_anthropic_stream_with_hooks(
                start_datetime,
                response,
                structured_model,
                original_args,
    ...
    async def _parse_anthropic_stream_with_hooks(
        self,
        start_datetime: datetime,
        ...
        async for chat_response in self._parse_anthropic_stream_completion_response(

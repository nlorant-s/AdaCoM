...
class OllamaChatModel(ChatModelBase):
    ...
    async def __call__(
        ...
        **kwargs: Any,
        ...
        if self.stream:
            return self._parse_ollama_stream_with_hooks(
                start_datetime,
                response,
                structured_model,
                original_args,
        ...
        return self._call_post_llm_hooks(
            parsed_response, *original_args, **original_kwargs_saved,
        )

    async def _parse_ollama_stream_with_hooks(
        self,
        ...
        async for chat_response in self._parse_ollama_stream_completion_response(

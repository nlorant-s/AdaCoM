        ...
        for msg in msgs:
            ...
            for block in msg.get_content_blocks():
                ...
                if typ == "text":
                    ...
                    # Preserve thinking blocks as text
            ...
            if tool_calls:
                ...
                # Some OpenAI-compatible providers (e.g. glm-4.5) reject
                # assistant messages with `content: null` — they require a
                # non-null content field even when tool_calls are present.
                if msg_openai["content"] is None:
                    msg_openai["content"] = ""

            # When both content and tool_calls are None, skipped
            if msg_openai["content"] is not None or msg_openai.get("tool_calls"):
